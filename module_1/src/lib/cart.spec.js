...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    ...
    it('should ensure no more that one product at times', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('special conditions', () => {
    ...
    it('should receive two or more conditions and determine/apply the best discount. First case is', () => {
      const condition1 = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should receive two or more conditions and determine/apply the best discount. Second case is', () => {
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
